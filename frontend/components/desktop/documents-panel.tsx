          ...
          <FileTreeFolder name="Uploads" path="uploads">
            <FileTreeFolder name="Invoices" path="invoices">
              <FileTreeFile
                ...
                icon={<Icons.FileTypePdf className="size-3.5 text-white/50" />}
              />
              <FileTreeFile
            ...
            <FileTreeFolder name="Receipts" path="receipts">
              <FileTreeFile
                ...
                icon={<Icons.Image className="size-3.5 text-white/50" />}
              />
              <FileTreeFile
            ...
            <FileTreeFile
              ...
              icon={<Icons.Table className="size-3.5 text-white/50" />}
            />
          </FileTreeFolder>
