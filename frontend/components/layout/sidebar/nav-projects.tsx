          ...
          <div className="flex w-full items-center justify-between">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href="/stacks/new"
                  className="opacity-0 group-hover/collapsible:opacity-100 p-1 hover:bg-sidebar-accent rounded-md transition-all -mr-1"
                >
              ...
              {stacks.map((stack) => (
                <SidebarMenuItem key={stack.id}>
                  <SidebarMenuButton
                    ...
                    className={cn(
                      "gap-1.5",
                      pathname === `/stacks/${stack.id}` && "bg-sidebar-accent"
                    )}
                  >
